  ...
  return (
    <>
      ...
      <ul className="list-items">
        <Link
          to={`/item/${topRates[0].id}`}
          state={{ data: topRates[0] }}
        ...
        >
          <li className="list-item">
            ...
            <p className="rating">
              {topRates[0].ratingRate}
              <img src={starIcon} />
            </p>

            <Price item={topRates[0]} />
            <p className="description">
              {topRates[0].description.slice(0, 150) + "....."}
            </p>
          </li>
        </Link>

        <Link
          to={`/item/${topRates[1].id}`}
          state={{ data: topRates[1] }}
          className="list-items"
        >
          <li className="list-item">
            ...
            <p className="rating">
              {topRates[1].ratingRate}
              <img src={starIcon} />
            </p>
            <Price item={topRates[1]} />
            <p className="description">
              {topRates[1].description.slice(0, 150) + "....."}
            </p>
          </li>
        </Link>
      </ul>
